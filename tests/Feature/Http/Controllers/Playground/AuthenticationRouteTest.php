...
/**
 * \Tests\Feature\Playground\Login\Blade\Http\Controllers\Playground\AuthenticationRouteTest
 */
class AuthenticationRouteTest extends TestCase
{
    ...
    public function test_users_can_authenticate_using_the_login_screen_playground(): void
    {
        /**
         * @var User $user
         */
        ...
        //             'hashed' => config('playground-test.password_encrypted'),
        //             'playground-test' => config('playground-test'),
        //         ]);
